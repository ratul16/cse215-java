...
public class GameBoard extends JPanel implements KeyListener {
	...
	public GameBoard(){
		...
		for(int i = 0; i < ghosts.length; i++){
			...
			ghosts[i] = new Ghost(xGhostPos, yGhostPos,"images//ghost.png",true);
			xGhostPos += 40;
		}
	...
	public void keyPressed(KeyEvent e) {
		...
		if(e.getKeyCode() == e.VK_LEFT){
			...
			BulletFiring bf = new BulletFiring(this,ghosts,bullets[bulletCount]);
			bf.start();
